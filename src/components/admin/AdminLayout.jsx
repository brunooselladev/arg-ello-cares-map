...
import { Heart, MapPin, Newspaper, Megaphone, Users, MessageSquare, Settings, LogOut, Home, Menu, ImageIcon, Palette, } from 'lucide-react';
          ...
          <SidebarGroupContent>
            ...
            return (<SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild>
                      <Link href={item.url} className={cn('flex items-center gap-3 px-3 py-2 rounded-md transition-colors', isActive ? 'bg-primary text-primary-foreground' : 'hover:bg-muted')}>
