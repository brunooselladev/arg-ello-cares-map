      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardContent className="p-0">
            {isLoading ? (<div className="p-8 text-center text-muted-foreground">Cargando...</div>) : volunteers.length === 0 ? (<div className="p-8 text-center text-muted-foreground">
                ...
                <TableBody>
                  {volunteers.map((vol) => (<TableRow key={vol.id}>
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          ...
                          {vol.phone && (<div className="flex items-center gap-1 text-sm text-muted-foreground">
                      ...
                      <TableCell>
                        {vol.availability ? (<div className="flex items-center gap-1 text-sm">
                            <Clock className="h-3 w-3 text-muted-foreground"/>
                            {vol.availability}
                          </div>) : (<span className="text-muted-foreground">-</span>)}
                      </TableCell>
                      <TableCell className="max-w-[200px]">
                        {vol.message ? (<p className="text-sm text-muted-foreground truncate" title={vol.message}>
                            {vol.message}
