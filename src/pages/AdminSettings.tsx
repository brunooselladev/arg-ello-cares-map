    ...
    <AdminLayout>
      <div className="space-y-6 max-w-3xl">
        ...
        <Card>
          ...
          <CardContent>
            <Link to="/admin/banners" className="inline-flex items-center text-primary hover:underline">
        ...
        <Card>
          ...
          <CardContent>
            <Link to="/admin/theme" className="inline-flex items-center text-primary hover:underline">
