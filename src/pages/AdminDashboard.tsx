        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            ...
            <CardContent className="space-y-2">
              <Link to="/admin/map-points" className="block p-3 rounded-md bg-muted hover:bg-muted/80 transition-colors">
                <div className="flex items-center gap-3">
                  <MapPin className="h-5 w-5 text-nodo" />
                  <span className="font-medium">Agregar punto al mapa</span>
                </div>
              </Link>
              <Link to="/admin/news" className="block p-3 rounded-md bg-muted hover:bg-muted/80 transition-colors">
                <div className="flex items-center gap-3">
                  <Newspaper className="h-5 w-5 text-centro-escucha" />
                  <span className="font-medium">Crear novedad</span>
                </div>
              </Link>
              <Link to="/admin/campaigns" className="block p-3 rounded-md bg-muted hover:bg-muted/80 transition-colors">
                <div className="flex items-center gap-3">
              ...
              {volunteers.slice(0, 5).length > 0 ? (
                <ul className="space-y-2">
                  {volunteers.slice(0, 5).map((vol) => (
                    <li key={vol.id} className="flex justify-between items-center text-sm gap-4">
                ...
                <p className="text-sm text-muted-foreground">No hay voluntarios registrados aun.</p>
              )}
            </CardContent>
          </Card>
        </div>
